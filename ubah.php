...
$query_detail = mysqli_query($db, 'SELECT * FROM tamu WHERE id = $id');     
while ($data_detal = mysqli_fetch_array($query_detail)) {
    $detail[] = $data_detail;
};
        ...
        <td>
            ...
            <table>
                <tr>
                    <td>ID</td>
                    <td>:</td>
                    <td><input type="text" name="id" readonly="" values="<?= $detail['id']?>" class="form-control"></td>
                </tr>
                <tr>
                    <td>Nama</td>
                    <td>:</td>
